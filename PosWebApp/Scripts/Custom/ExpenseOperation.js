...
function expenseInfoShow() {
    ...
    var action = "<td class='text-center'><a class='btn btn-info btn-sm editExpense' href='#'><i class='glyphicon glyphicon-edit'></i></a> &nbsp; ";
    action += "<a class='btn btn-danger btn-sm deleteExpense' href='#'><i class='glyphicon glyphicon-trash'></i></a></td>";
